    ...
    for e in range(1, conf["global_epochs"]):
        ...
        for cluster in server.clusters:
            ...
            for i in range(len(cluster)):
                ...
                clients[cur_client].local_train(last_local_model)
        ...
        print("before: {}; after: {}".format(ids, aggregate_ids))
        acc, loss = server.model_weight_aggregate(aggregate_models, client_datalen, total_len, aggregate_ids)
