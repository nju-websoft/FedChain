...
infoln "Joining org$NEW_ORG peer to the channel..."
joinChannel $NEW_ORG

infoln "Setting anchor peer for org$NEW_ORG..."
setAnchorPeer $NEW_ORG

successln "Channel '$CHANNEL_NAME' joined"
successln "Org$NEW_ORG peer successfully added to network"
